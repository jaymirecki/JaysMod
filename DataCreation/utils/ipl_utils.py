...
def xml_to_csv(root: ET.Element):
    ...
    portals = to_csv.multipart_list(root, "Portals", ["ID", "Position", "Heading", "PortalType"])
...
def csv_to_xml(row, destination_path):
    ...
    portals = to_xml.multipart_list(root, "Portals", row["Portals"], "RoomPortal", ["ID", "Position", "Heading", "PortalType"])
